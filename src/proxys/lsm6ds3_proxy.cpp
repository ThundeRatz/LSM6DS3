...
int8_t LSM6DS3_Proxy::init(lsm6ds_settings_t lsm6ds_settings, lsm6ds_I2C_pinout_t I2C_pinout_config, platform_read_f platform_read, platform_write_f platform_write) {
    int32_t error_code;
...
int8_t LSM6DS3_Proxy::init(lsm6ds_settings_t lsm6ds_settings, lsm6ds_SPI_pinout_t SPI_pinout_config, platform_read_f platform_read, platform_write_f platform_write) {
    int32_t error_code;
    sensor_settings = lsm6ds_settings;
...
void LSM6DS3_Proxy::update_data() {
    // uint8_t reg;
    // int32_t error_code;
...
void LSM6DS3_Proxy::update_data_ready_interrupt() {
    // int32_t error_value;
...
void LSM6DS3_Proxy::update_data_fifo_full_interrupt() {
    // uint16_t fifo_size;
...
void LSM6DS3_Proxy::reset_fifo() {
    // lsm6ds3tr_c_fifo_mode_set(&dev_ctx, LSM6DS3TR_C_BYPASS_MODE);
    // lsm6ds3tr_c_fifo_mode_set(&dev_ctx, LSM6DS3TR_C_FIFO_MODE);
}

float* LSM6DS3_Proxy::get_acc_data_mg() {
    //return acceleration_mg;
}

float* LSM6DS3_Proxy::get_gyro_data_mdps() {
...
int8_t LSM6DS3_Proxy::base_init() {
    // uint8_t rst;
    // int32_t error_code;
...
int8_t LSM6DS3_Proxy::interrupt_init() {
    // int32_t error_code;
...
int8_t LSM6DS3_Proxy::fifo_mode_init() {
    // int32_t error_code;
    // lsm6ds3tr_c_pin_int1_route_get(&dev_ctx, &int_1_reg);
    // lsm6ds3tr_c_pin_int2_route_get(&dev_ctx, &int_2_reg);
